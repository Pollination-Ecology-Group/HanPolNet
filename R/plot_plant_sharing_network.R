...
#'
#' @param size_by A character string: `"interactions"` (default) or `"abundance"`.
...
#' @param ... Filtering arguments passed to `get_interaction_data()`.
#'
...
plot_plant_sharing_network <- function(size_by = "interactions",
  ...
  network_tibble <- interaction_subset %>%
  ...
  # --- FIX: Convert the tibble to a proper matrix ---
  network_matrix <- network_tibble %>%
