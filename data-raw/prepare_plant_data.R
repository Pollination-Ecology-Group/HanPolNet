...
plant_metadata_raw <- read.csv("data-raw/plant_code_table.csv", row.names = 1)
...
# Let's create them!
plant_metadata <- plant_metadata_raw
plant_metadata$plant_name <- gsub("_", " ", plant_metadata$plant_name)


# --- 3. Clean and process the abundance data ---
...
# --- 4. Save the clean data to the `data/` directory ---
...
message("✅ `plant_abundance.rda` and `plant_metadata.rda` have been created.")
